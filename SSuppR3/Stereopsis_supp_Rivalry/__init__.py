...
def fixation(d):
    ...
    d.rectangle((int(sz / 2) + eccentricity*2, int(sz / 2) + eccentricity*2,
                 int(sz / 2) - eccentricity*2, int(sz / 2) + eccentricity*2),
                fill=(0, 0, 255), outline=None)
    d.rectangle((int(sz / 2) - eccentricity*2, int(sz / 2) + eccentricity*2,
                 int(sz / 2) - eccentricity*2, int(sz / 2) - eccentricity*2),
                fill=(0, 0, 255), outline=None)
...
shutil.copyfile("stereograms/0ls.png", "stereograms/-0ls.png")
